  ...
  return (
    <div className="bg-primaryBlue py-12 px-6 flex flex-col items-center">
      ...
      <div className="text-center">
        ...
        <p className="text-sm font-montagu text-gray-600 mb-8 max-w-2xl mx-auto">
          Don&apos;t hesitate to contact our team for more information or to set
          up an appointment.
          <br /> We are ready to help you find your dream home.
        </p>
        <button className="bg-primaryOrange text-white px-8 py-4 rounded-lg hover:bg-orange-600">
          Call Us
        </button>
      </div>
    </div>
